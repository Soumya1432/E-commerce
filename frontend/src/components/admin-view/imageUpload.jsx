...
const ProductImageUpload = ({imageFIle,setImageFile,imageLoadingState,uploadedImageUrl,setUploadedImageUrl,setImageLoadingState,isEditMode }) => {
 ...
 useEffect(()=>{
  ...
  return (
    <div className='w-full max-w-md mx-auto'>
        ...
        <div onDragOver={handleDragOver} onDrop={handleDrop} className={`${isEditMode ?"opacity-65" :" "}border-2 border-slate-400 border-dashed rounded-lg p-4  mt-4`}>
